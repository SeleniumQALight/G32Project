...
public class TestDB  {
    ...
    @Test
    public void dataFroDbTest() throws SQLException, IOException, ClassNotFoundException {
        ...
        int effectedRows = dbMySql.changeTable("INSERT INTO seleniumTable VALUES (2,'naumiak','pass')");
        logger.info("Effected = " + effectedRows);
        List<Map<String,String>> dataFromSeleniumTable1 =
                dbMySql.selectTable("select * from seleniumTable where login = 'naumiak'");
